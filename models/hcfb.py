...
class HCFB(nn.Module):
    ...
    def forward(self, shallow_ir, shallow_vis, deep_ir, deep_vis, task_signals=None):
        objectness = None if task_signals is None else task_signals["obj"]
        fused_shallow, shallow_stats = self.level1(shallow_ir, shallow_vis, objectness=objectness)
        ...
        fused_deep, deep_stats = self.level2(deep_ir, deep_vis, objectness=deep_objectness)
